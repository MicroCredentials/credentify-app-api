...
export function inject(app: Application) {
  app.get('/profile/abilities', (req: Request, res: Response, next: NextFunction) => {
...
export async function resolve(req: Request, res: Response): Promise<void> {
  ...
  return res.respond(200, context.profile.profileAbilities.map((a) => a.serialize(SerializedStrategy.PROFILE)));
}
